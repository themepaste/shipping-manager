...
<div class="wrap">
    <div class="themepaste-shipping-manager-wrapper">
        <?php echo wp_kses_post( Utility::get_template( 'settings/parts/topbar.php' ) ); ?>
        <div class="shipping-manager-container">
            <?php echo wp_kses_post( Utility::get_template( 'settings/parts/sidebar.php', $args ) ); ?>
            <?php echo wp_kses_post( Utility::get_template( 'settings/parts/main.php', $args ) ); ?>
        </div>
    </div>
</div>