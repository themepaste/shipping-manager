    ...
    function tpsm_general_settings_fields() {
        return array(
            ...
            'is-plugin-enable' => array(
                ...
                'type'  => 'switch',
                'value' => '',
                'desc'  => __( 'Enable or disable the shipping method. Default: enabled.', 'shipping-manager' ),
            ),
    ...
    function tpsm_free_shipping_settings_fields() {
        return array(
            ...
            'minimum-amount' => array(
                ...
                'type'  => 'switch',
                'value' => '',
                'desc'  => __( 'Enable custom minimum amount for free shipping. Otherwise, the default WooCommerce setting is used.', 'shipping-manager' ),
            ),
            'cart-amount' => array(
            ...
            'free-shipping-bar' => array(
                ...
                'child-fields' => array(
                    'shipping-bar-message' => array(
                        ...
                        'type'  => 'text',
                        'value' => '',
                        'desc'  => __( 'Use [left_price] as a placeholder for the remaining amount to qualify for free shipping.', 'shipping-manager' ),
                    ),
