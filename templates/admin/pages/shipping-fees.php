...
<form class="tsm-admin-settings-form" method="POST">
	...
	<div class="input-wrapper checkbox">
		<label for="<?php echo esc_attr( ShippingFeesSettings::ENABLE_PROCESSING_FEES ); ?>"><?php esc_html_e( 'Add Processing Fee', 'shipping-manager' ); ?></label>
		<input
	...
	<div class="input-wrapper amount">
		<label for="<?php echo esc_attr( ShippingFeesSettings::PROCESSING_FEES_AMOUNT ); ?>"><?php esc_html_e( 'Amount', 'shipping-manager' ); ?></label>
		<input
