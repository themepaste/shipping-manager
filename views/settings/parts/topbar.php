...
?>
        ...
        <div class="tpsm-titles">
            ...
            <p style="margin:0;">
                <?php esc_html_e( 'One solution for all shipping needs', 'shipping-manager' ); // Plugin tagline ?></p>
        </div>
    </div>
    ...
    <div class="tpsm-topbar-info-area">
        ...
        <a href="https://themepaste.com/documentation/shipping-manager/" target="_blank">
